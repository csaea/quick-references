...
For more detailed documentation, use the dictionary from [W3 Schools](https://www.w3schools.com/python/default.asp), the official [Python Tutorial](https://docs.python.org/3/tutorial/index.html), and/ or [TutorialsPoint](https://www.tutorialspoint.com/python/index.html).
